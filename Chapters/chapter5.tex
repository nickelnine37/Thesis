...
\begin{equation*}
    \text{KGR input data} = \Big\{ \X \in \R^{T \times M}, \; \Y \in \R^{N \times T}, \; \Ss \in [0, 1]^{N \times T} \Big\}
\end{equation*}
...
\begin{equation*}
    \text{RNC input data} = \Big\{ \Xt \in \R^{N \times T \times M}, \; \Y \in \R^{N \times T}, \; \Ss \in [0, 1]^{N \times T}\Big\}
\end{equation*}
