...
\note{Is GSR appropriate? A statistical test }{
    ...
    \begin{enumerate}
        ...
        \item Shift and scale the vector of observed data $\widetilde{\y}$ such that it has a mean of zero and unit variance across the observed elements. 
